...
<h1 align="center">Rakibul Islam — Frontend-first MERN Developer</h1>

<p align="center">
  <img src="https://img.shields.io/badge/Role-Junior_MERN_Developer-0ea5e9?style=for-the-badge&logo=react&logoColor=white" />
  <img src="https://img.shields.io/badge/Base-Chittagong%2C_BD-312e81?style=for-the-badge&logo=googlemaps&logoColor=white" />
...
| -------------------------------- | ---------------------- | ------------------------------- | ------------------------------------------------- |
| Junior MERN + Frontend Craftsman | Chittagong, Bangladesh | Freelance • Internship • Remote | Advanced React patterns, animations, API security |

> _"Simple, fast, and delightful — that’s the benchmark for every build."_
...
![Figma](https://img.shields.io/badge/Figma-111827?style=for-the-badge&logo=figma&logoColor=38bdf8)
...
- Design for clarity first, then add motion for delight.
- Ship iteratively using feature flags and preview links.
- Automate repetitive tasks (lint, formatting, deployments) so creativity gets more time.
